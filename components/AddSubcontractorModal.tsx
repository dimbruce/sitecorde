...
interface AddSubcontractorModalProps {
  onClose: () => void;
  onCreate: (data: { name: string; tradeType: string; phone: string; email: string; }) => void;
}

const AddSubcontractorModal: React.FC<AddSubcontractorModalProps> = ({ onClose, onCreate }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/30 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="add-sub-title">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md relative flex flex-col">
            <div className="p-4 border-b border-slate-200 flex justify-between items-center flex-shrink-0">
              <h2 id="add-sub-title" className="text-xl font-bold text-slate-800 flex items-center gap-2">
              ...
              <div className="p-6 space-y-6">
                ...
                <fieldset>
                    <div className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="name" className="block text-sm font-medium text-slate-700 mb-1">Subcontractor/Company Name</label>
                            <input 
                                type="text" 
                                name="name" 
                                id="name" 
